...
> [README](../README.md)). PostgreSQL queda publicado en `localhost:15447`.
...
| Port | `15447` | El puerto del host del compose (`15447:1433`) |
...
> El puerto es la clave: **15447, no 1433**. Dentro de la red de Docker
> la BD escucha en 1433, pero hacia su PC el compose la publica en 15447
...
>
> ```
> Error opening connection Failed to connect to localhost:15447
...
> (`http://localhost:8047/api/producto/PR009`) — un solo dato, muchos
> clientes.
...
| 1 | Crear la conexión (localhost:15447) con test y guardarla |

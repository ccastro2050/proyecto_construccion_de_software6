...
└── api_facturas/
    ...
    ├── Dockerfile                    # sdk:10.0 + dotnet watch (puerto 8047)
    ├── Modelos/
...
funcionando. En v1 eso son **dos servicios**: `postgres` (15447 al host,
se siembra solo) y `api-facturas` (8047, código montado +

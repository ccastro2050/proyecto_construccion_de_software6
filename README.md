...
> ## 🌐 ENTRAR AL FRONT → **http://localhost:8049**
...
> el puerto 8047 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                               STATUS                    PORTS
> proyecto_construccion_de_software6-api-facturas-1   Up 2 hours                0.0.0.0:8047->8047/tcp
> proyecto_construccion_de_software6-postgres-1       Up 2 hours (healthy)      0.0.0.0:15447->5432/tcp
> ```
>
...
```powershell
git clone https://github.com/ccastro2050/proyecto_construccion_de_software6.git
cd proyecto_construccion_de_software6
...
```
proyecto_construccion_de_software6/
